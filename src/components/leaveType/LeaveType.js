...
const LeaveType = () => {
    ...
    async function handleCreate(e) {
        const response = await fetch(baseUrl + '/admin/leave_type', {
            method: 'POST',
            headers: {
    ...
    async function handleSaveEdit(e) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/leave_type/' + editSourceId, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function handleDelete(e, id) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/leave_type/' + id, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
