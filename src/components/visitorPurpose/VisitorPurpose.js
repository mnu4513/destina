...
const VisitorPurpose = () => {
    ...
    async function handleCreate(e) {
        const response = await fetch(baseUrl + '/admin/visitor_purpose', {
            method: 'POST',
            headers: {
    ...
    async function handleSaveEdit(e) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/visitor_purpose/' + editSourceId, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function handleDelete(e, id) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/visitor_purpose/' + id, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
