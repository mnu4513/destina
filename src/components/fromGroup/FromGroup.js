...
const FormGroup = () => {
    ...
    async function handleCreate(e) {
        const response = await fetch(baseUrl + '/admin/form_group', {
            method: 'POST',
            headers: {
    ...
    async function handleSaveEdit(e) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/form_group/' + editSourceId, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function handleDelete(e, id) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/form_group/' + id, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
