...
const StudentHouse = () => {
    ...
    async function handleCreate(e) {
        const response = await fetch(baseUrl + '/admin/student_house', {
            method: 'POST',
            headers: {
    ...
    async function toggleStatus(e, id) {
        e.preventDefault();
        try {
            const response = await fetch(`${baseUrl}/admin/student_house/${id}/status`, {
                method: 'PUT',
                headers: {
    ...
    // Edit house handler
    async function handleEdit(e, id, name, description) {
        e.preventDefault();
        setEditSourceId(id);
        setNameEdit(name);
    ...
    // Save edited house handler
    async function handleSaveEdit(e) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/student_house/' + editSourceId, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
                body: JSON.stringify({ name: nameEdit, description: descriptionEdit })
            });
    ...
    async function handleDelete(e, id) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/student_house/' + id, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
