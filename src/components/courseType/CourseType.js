...
const CoursesType = () => {
    ...
    async function handleCreate(e) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/course_type', {
                method: 'POST',
                headers: {
    ...
    async function toggleStatus(e, id) {
        e.preventDefault();
        try {
            const response = await fetch(`${baseUrl}/admin/course_type/${id}/status`, {
                method: 'PUT',
                headers: {
    ...
    async function handleSaveEdit(e) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/course_type/' + editSourceId, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function handleDelete(e, id) {
        e.preventDefault();
        try {
            const response = await fetch(baseUrl + '/admin/course_type/' + id, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                }
